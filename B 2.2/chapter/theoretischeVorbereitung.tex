\section{Theoretische Vorbereitung}
    \subsection{Reziprokes Gitter}
        ...
        an periodischem Gittern zu beschreiben, \hl{da es durch diese Beugungen gebildet wird.(?)}
        ...
        \subsubsection*{Bragg Gleichung}
            ...
            inteferieren können, muss der Wellenlängenunterschied $n\lambda$ betragen \hl{(destruktive $n\frac{\lambda}{2}$)}
    ...
    \subsection{Die röntgenographische Methode}
        ...
        \subsubsection{Röntgenstrahlung}    
            ...
            100eV oder einer Wellenlänge $~10 nm$. In diesem Versuch benötigt man eine Wellenlänge von $\lambda \thicksim 0.1 nm$, \hl{da 
            ...
            Abbremsen der Elektronen an der Anode.\hl{durch die verschiedenen Endenergien der auftreffenden Elektronen.} 
    ...
    \subsection{Die resistive Methode}
        ...
        \subsubsection{Elektrische Leitfähigkeit}
            ...
            (\hl{glaube ich zumindest so keine Ahnung grad})
