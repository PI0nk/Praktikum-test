\section{Theoretische Vorbereitung}
    \subsection{Grundlegende Beziehungen}
        \subsubsection{Magnetfelder}
            ...
            \begin{equation}
                \vec{B} = \mu_0 \vec{H}
            \end{equation}
            $\mu_0\approx 4\pi \cdot 10^{-7}\frac{N}{A^2}$ bezeichnet dabei die magnetische Permeabilität des Vakuums.
    ...
    \subsection{Magnetismus ohne Ordnungsphänomene}
        ...
        \subsubsection*{Spin-,Bahnmagnetismus und Land\'e-Faktor}
            ...
            und dem "klassisch" errechneten eines Elektrons. Für Elektronen ist $g_s \approx 2$.
